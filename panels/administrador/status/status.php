                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Nuevo status</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <div class="modal-body">
                              <form action="valStatus.php" method="POST">
                              <div class="mb-3">
                                <label for="status" class="form-label">Nombre del status</label>
                                <input type="text" class="form-control" name="status" id="status" placeholder="Nombre del status">
                              </div>
                                      ...
                                      <?php
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <a href="delete.php?id=<?php echo $row['id']?>" onclick="return confirm('Estas seguro que deseas eliminar?')" class="btn btn-danger">
                                              Eliminar
                                            </a>
                                          </td>
                                        </tr>
