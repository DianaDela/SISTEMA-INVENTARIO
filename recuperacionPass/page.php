...
<head>
    ...
    <title>Recuperar contraseña || Grupo Piasa</title>
...
<div class="container-fluid row justify-content-center">
    <img src="../img/logo.png" alt="" srcset="" style="width: 500px;">
  </div>
</nav>
        ...
        <div class="card text-center" style="margin: 50px;">
            ...
            <div class="card-body">
                ...
                <div class="d-grid gap-2">
                    <button class="btn btn-success" type="submit" style="margin: 12px; width: 100px;">Enviar</button>
                </div>                
                </form>
            </div>
        </div>
